...
# from models.NEXTVit import C3NCB
...
# 自己添加
from models.MySimAM import SimAM
from models.MySE import SEAttention
from models.MyShuffleAttention import ShuffleAttention
#from models.MyCBAM import CBAMBlock
from models.Myextra_modules import CSPStage
from models.NEXTVit import C3NCB,NTBBOT
from models.Slimneck import GSConv,VoVGSCSPOLD
...
#             HGBlock,
            ...
            args = [c1, c2, *args[1:]]
            if m in {BottleneckCSP, C3, C3TR, C3Ghost, C3x, CSPStage, C2f, C3_MSBlock, C3NCB, VoVGSCSPOLD, C3_Res2Block}:
                args.insert(2, n)  # number of repeats
                n = 1
        elif m is nn.BatchNorm2d:
            args = [ch[f]]
        elif m in {MLCABOT, NTBBOT}:
            c2 = ch[f] * 2
            args = [ch[f],*args]
...
if __name__ == "__main__":
    ...
    parser.add_argument("--cfg", type=str, default="test_two.yaml", help="model.yaml")
